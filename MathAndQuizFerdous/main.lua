		      ...
		      -- local  giveAnswerText = display.newText("the answer is  = ".. correctAnswer, display.contentWidth/2, display.contentHeight*2/3, nil, 50 )
		        --giveAnswerText.x= 500
		        --giveAnswerText.y=600
		        --giveAnswerText.isVisible=false
				--pointText=50
