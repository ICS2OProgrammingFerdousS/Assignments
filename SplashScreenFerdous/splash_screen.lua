...
local backgroundSound = audio.loadSound("Sounds/123.wav")
...
--scalling the image 
    companyLogo.xScale = companyLogo.xScale + 0.04
    companyLogo.yScale = companyLogo.yScale + 0.04
...
-- Call the logoEntry function as soon as we enter the frame.
...
-- The function called when the scene is has to leave the screen
